    ...
    <div className="ticket-form" data-force-light>
      ...
      <form onSubmit={(e) => {e.preventDefault(); handleSubmit()}} noValidate className="tf-grid">
        ...
        <div className="tf-field tf-col-2">
          ...
          <input id="archivo" type="file" multiple onChange={(e) =>  {setField("archivo", Array.from(e.target.files ?? [])); console.log(state.archivo)}} disabled={submitting} className="tf-input"/>
